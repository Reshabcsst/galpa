...
namespace Galpa.Controllers.AuthorsController
{
    ...
    [ApiController]
    public class AuthorBannerController : ControllerBase
    {
        ...
        public AuthorBannerController(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> AddBannerItem([FromForm] BannerModel banner)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(connectionString))
            {
                ...
                int newId = 1;
                using (MySqlCommand cmd = new MySqlCommand("SELECT MAX(Id) FROM authorbanner", con))
                {
                ...
                using (MySqlCommand cmd = new MySqlCommand("INSERT INTO authorbanner (Id, Heading, Subheading, BackgroundImage) VALUES (@Id, @Heading, @Subheading, @BackgroundImage)", con))
                {
        ...
        public IActionResult GetBannerItem()
        {
            ...
            using (MySqlConnection con = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM authorbanner", con))
                {
        ...
        public async Task<IActionResult> EditBannerItem(int id, [FromForm] BannerModel banner)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand getCmd = new MySqlCommand("SELECT Heading, Subheading, BackgroundImage FROM authorbanner WHERE Id = @Id", con))
                {
                ...
                using (MySqlCommand cmd = new MySqlCommand("UPDATE authorbanner SET Heading = @Heading, Subheading = @Subheading, BackgroundImage = @BackgroundImage WHERE Id = @Id", con))
                {
        ...
        public IActionResult DeleteBannerItem(int id)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand("DELETE FROM authorbanner WHERE Id = @Id", con))
                {
                    cmd.Parameters.AddWithValue("@Id", id);
