...
const ContactBanner = ({ ServerURL }) => {
    ...
    const handleEdit = () => {
        ...
        axios.put(`${ServerURL}/api/ContactBanner/edit-contact-banner/${selectedBanner.id}`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
            ...
            .then(response => {
                ...
                return axios.get(`${ServerURL}/api/ContactBanner/get-contact-banner`, {
                    headers: {
                        'Authorization': `Bearer ${token.token}`
                    }
                });
    ...
    const handleAdd = () => {
        ...
        axios.post(`${ServerURL}/api/ContactBanner/add-contact-banner`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
                'Content-Type': 'multipart/form-data'
            }
    ...
    return (
        <div className="our_work">
            <h2 className='admin_heading'>Contact Banner</h2>
