...
const Banner = ({ ServerURL }) => {
    ...
    const handleEdit = () => {
        ...
        axios.put(`${ServerURL}/api/ServiceBanner/edit-service-banner/${selectedBanner.id}`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
            ...
            .then(response => {
                ...
                return axios.get(`${ServerURL}/api/ServiceBanner/get-service-banner`, {
                    headers: {
                        'Authorization': `Bearer ${token.token}`
                    }
                });
    ...
    const handleAdd = () => {
        ...
        axios.post(`${ServerURL}/api/ServiceBanner/add-service-banner`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
                'Content-Type': 'multipart/form-data'
            }
    ...
    return (
        <div className="our_work">
            <h2 className='admin_heading'>Service Banner</h2>
