...
const AuthorBanner = ({ ServerURL }) => {
    ...
    const handleEdit = () => {
        ...
        axios.put(`${ServerURL}/api/AuthorBanner/edit-author-banner/${selectedBanner.id}`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
            ...
            .then(response => {
                ...
                return axios.get(`${ServerURL}/api/AuthorBanner/get-author-banner`, {
                    headers: {
                        'Authorization': `Bearer ${token.token}`
                    }
                });
    ...
    const handleAdd = () => {
        ...
        axios.post(`${ServerURL}/api/AuthorBanner/add-author-banner`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
                'Content-Type': 'multipart/form-data'
            }
    ...
    return (
        <div className="our_work">
            <h2 className='admin_heading'>Author Banner</h2>
