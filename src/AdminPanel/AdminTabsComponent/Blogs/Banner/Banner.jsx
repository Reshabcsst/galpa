...
const BlogBanner = ({ ServerURL }) => {
    ...
    const handleEdit = () => {
        ...
        axios.put(`${ServerURL}/api/BlogsBanner/edit-blog-banner/${selectedBanner.id}`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
            ...
            .then(response => {
                ...
                return axios.get(`${ServerURL}/api/BlogsBanner/get-blog-banner`, {
                    headers: {
                        'Authorization': `Bearer ${token.token}`
                    }
                });
    ...
    const handleAdd = () => {
        ...
        axios.post(`${ServerURL}/api/BlogsBanner/add-blog-banner`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
                'Content-Type': 'multipart/form-data'
            }
    ...
    return (
        <div className="our_work">
            <h2 className='admin_heading'>Blog Banner</h2>
