...
const AboutBanner = ({ ServerURL }) => {
    ...
    const handleEdit = () => {
        ...
        axios.put(`${ServerURL}/api/AboutBanner/edit-about-banner/${selectedBanner.id}`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
            ...
            .then(response => {
                ...
                return axios.get(`${ServerURL}/api/AboutBanner/get-about-banner`, {
                    headers: {
                        'Authorization': `Bearer ${token.token}`
                    }
                });
    ...
    const handleAdd = () => {
        ...
        axios.post(`${ServerURL}/api/AboutBanner/add-about-banner`, formData, {
            headers: {
                'Authorization': `Bearer ${token.token}`,
                'Content-Type': 'multipart/form-data'
            }
    ...
    return (
        <div className="our_work">
            <h2 className='admin_heading'>About Banner</h2>
